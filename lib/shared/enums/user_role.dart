...
// // lib/shared/enums/user_role_enum.dart
// enum UserRoleEnum {
//   member,
//   chairman,
//   viceChairman,
...
//         return 'Member';
//       case UserRoleEnum.chairman:
//         return 'Chairman';
//       case UserRoleEnum.viceChairman:
//         return 'Vice Chairman';
//       case UserRoleEnum.secretary:
//         return 'Secretary';
//       case UserRoleEnum.viceSecretary:
//         return 'Vice Secretary';
//       case UserRoleEnum.accountant:
//         return 'Accountant';
//       case UserRoleEnum.districtRepresentative:
//         return 'District Representative';
...
//     switch (this) {
//       case UserRoleEnum.member:
//         return 'Regular organization member';
//       case UserRoleEnum.chairman:
//         return 'Organization chairman with full administrative rights';
//       case UserRoleEnum.viceChairman:
//         return 'Vice chairman with delegated administrative rights';
//       case UserRoleEnum.secretary:
//         return 'Secretary responsible for documentation and communication';
//       case UserRoleEnum.viceSecretary:
//         return 'Assistant secretary with limited secretarial duties';
//       case UserRoleEnum.accountant:
//         return 'Financial officer responsible for accounting matters';
//       case UserRoleEnum.districtRepresentative:
//         return 'Representative for a specific district';
//       case UserRoleEnum.admin:
//         return 'System administrator with technical privileges';
//     }
//   }
...
//   bool get canApproveMembers {
//     return level >= 4; // Accountant and above
//   }

//   bool get canCreateNews {
//     return level >= 2; // District Representative and above
//   }

//   bool get canManageRoles {
//     return level >= 6; // Vice Chairman and above
//   }
...
//     switch (this) {
//       case UserRoleEnum.member:
//         return ['read_news', 'update_profile'];
//       case UserRoleEnum.districtRepresentative:
//         return ['read_news', 'create_news', 'update_profile', 'view_members'];
//       case UserRoleEnum.viceSecretary:
//         return [
//           'read_news',
//           'create_news',
